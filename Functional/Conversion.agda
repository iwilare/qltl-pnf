...
-}
module Functional.Conversion where
...
open import Functional.Counterpart
open import Functional.QLTL renaming (_,_⊨_ to _,_⊨QLTL_)
open import Functional.PNF renaming (_,_⊨_ to _,_⊨PNF_)
